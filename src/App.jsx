...
function WalletCard({ chain, address }) {
  return (
   <div className="border border-[#fdf6ee] rounded-2xl p-4 flex justify-between items-center h-32 bg-zinc-800/30 backdrop-blur-md transition-shadow duration-200 hover:shadow-[0_0_5px_#fdf6ee]">
